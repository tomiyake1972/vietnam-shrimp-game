  ...
  for (const record of caseResult.history) {
    ...
    for (const product of ["pd", "vap"] as const) {
      sai5MarketEvolutionTrace.push({
        ...
        addressableDemandHosoEqTons: evo.addressableDemandByProduct[product],
        externalOptionQuantityHosoEqTons: evo.externalOptionQuantityByProduct[product],
        supplyPressure: evo.supplyPressureByProduct[product],
        supplyPressureEwma: evo.supplyPressureEwmaByProduct[product],
        supplyPressureDefinition: evo.supplyPressureDefinition,
