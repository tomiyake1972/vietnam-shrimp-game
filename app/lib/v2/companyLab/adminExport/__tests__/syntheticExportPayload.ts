...
export function buildSyntheticCompanyExportPayload(
  ...
  const base: CompanyExportPayload = {
    ...
    financialResult: {
      ...
      manufacturingCost: {
        domesticRawMaterialCost: 300,
        importedRawMaterialCost: 0,
        aquacultureRawMaterialCost: 0,
        regularLaborCost: 82,
        productiveRegularLaborCost: 80,
        idleLaborCost: 2,
        temporaryWorkerCost: 20,
        overtimeCost: 10,
        hosoProcessingCost: 60,
        pdAdditionalProcessingCost: 30,
        vapAdditionalProcessingCost: 10,
        factoryFixedCost: 40,
        utilityFixedCost: 10,
        utilityVariableCost: 10,
        depreciationCost: 50,
        existingAssetBuildingDepreciationCost: 20,
        existingAssetMachineryDepreciationCost: 30,
        capexAssetsBuildingDepreciationCost: 0,
        capexAssetsMachineryDepreciationCost: 0,
        reworkCost: 5,
      },
      qualityLoss: {
        qualityDiscardLoss: 3,
        rawMaterialExpiryLoss: 0,
        finishedGoodsWriteOffLoss: 0,
        reworkCost: 5,
        downgradeSalesDeduction: 10,
        discardQuantityTons: 1,
      ...
      contributionMargin: {
        ...
        salesDeduction: 10,
        netRevenue: 990,
        variableRawMaterialCost: 300,
        variableProcessingCost: 100,
        variableLaborCost: 30,
        variableQualityCost: 8,
        variableSellingCost: 20,
        totalVariableCost: 458,
        contributionMargin: 532,
        contributionMarginRatio: 532 / 990,
        fixedManufacturingCost: 182,
        fixedPersonnelCost: 60,
        fixedSellingAdminCost: 40,
        totalFixedCost: 282,
        managementOperatingProfit: 250,
      ...
      absorptionVariableReconciliation: {
        fixedCostInOpeningInventory: 0,
        fixedCostAbsorbedIntoInventory: 0,
        fixedCostReleasedThroughSales: 0,
        fixedCostReleasedThroughWriteOff: 0,
        fixedCostInClosingInventory: 0,
        absorptionOperatingProfit: 340,
        variableCostingOperatingProfit: 250,
        profitDifference: 90,
      },
      cashShortfall: false,
