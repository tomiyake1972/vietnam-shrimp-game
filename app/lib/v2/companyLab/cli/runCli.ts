...
import { generateStandardAiDecision } from "../standardAi/provider";
...
export function runCompanyLabCli(argv: readonly string[]): CliInvocationResult {
  ...
  try {
    const decisionProvider = args.ai === "standard-ai" ? generateStandardAiDecision : generateAutoPolicyDecision;
