...
export function buildOpeningBalanceSheet(ownState: CompanyOwnState): OpeningBalanceSheet {
  ...
  return {
    assets: [
      { label: "現金", value: cash },
      { label: "売掛金", value: receivables },
      { label: "原料在庫", value: rawMaterialInventory },
      { label: "完成品在庫", value: finishedGoodsInventory },
      { label: "その他流動資産", value: otherCurrentAssets },
      { label: "固定資産 取得原価", value: fixedAssetsGross },
      { label: "　減価償却累計額", value: -accumulatedDepreciation },
      { label: "固定資産 純額", value: fixedAssetsNet, emphasis: true },
      { label: "建設中勘定", value: constructionInProgress },
      { label: "資産合計", value: totalAssets, emphasis: true },
    ],
    liabilities: [
      { label: "買掛金", value: payables },
      { label: "短期借入金", value: shortTermLoans },
      { label: "長期借入金", value: longTermLoans },
      { label: "その他負債", value: otherLiabilities },
      { label: "負債合計", value: totalLiabilities, emphasis: true },
    ],
    equity: [
      { label: "資本金", value: capitalStock },
      { label: "利益剰余金", value: retainedEarnings },
      { label: "純資産合計", value: totalEquity, emphasis: true },
    ],
    totalAssets,
    totalLiabilities,
    totalEquity,
